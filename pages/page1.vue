<template>
 ...
 <!-- header -->
  <div class="header" id="home">
    <div class="container">
      <div class="logo">
        <h1><a href="index.html"><i><img src="/images/logo.png" alt=""></i>Real Property</a></h1>
      </div>
          ...
          <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
            ...
            <nav class="link-effect-9" id="link-effect-9">
              <ul class="nav navbar-nav">
                ...
                <li><a href="#about" class="hvr-overline-from-center scroll">About Us</a></li>
                <li><a href="#team" class="hvr-overline-from-center scroll">Our Team</a></li>
                <li><a href="#blogs" class="hvr-overline-from-center scroll">Blogs</a></li>
                <li><a href="#properties" class="hvr-overline-from-center scroll">Properties</a></li>
                <li><a href="#contact" class="hvr-overline-from-center scroll">Contact Us</a></li>
              </ul>
            </nav>
          </div>
          <!-- /.navbar-collapse -->
      ...
      <div class="col-md-6 left-agile">
        <div id="horizontalTab">
          ...
          <div class="resp-tabs-container">
            <div class="tab1">
              <h4 class="sub-w3l">Introduction</h4>
              <p class="subp-w3l in1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sollicitudin lobortis sem, sed fermentum neque condimentum eu fermentum dolor. </p>
              <h4 class="sub-w3l">Lorem Ipsum</h4>
              <p class="subp-w3l in1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sollicitudin lobortis sem, sed fermentum neque condimentum ac. Phasellus elementum nibh Nunc in tempus neque, eu fermentum dolor. </p>
            </div>
            <div class="tab2">
              <i class="fa fa-cog i1" aria-hidden="true"></i>
              <h4 class="sub-w3l">Service 1</h4>
              <p class="subp-w3l">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sollicitudin lobortis sem, sed fermentum neque condimentum ac. Phasellus elementum nibh Nunc in tempus neque, eu fermentum dolor. </p>
              <i class="fa fa-home i1" aria-hidden="true"></i>
              <h4 class="sub-w3l">Service 2</h4>
              <p class="subp-w3l">Ut interdum, quam in tempus tristique, turpis magna interdum nulla, sit amet interdum lacus tortor vitae ipsum. Etiam in hendrerit odio, sit amet semper nibh. Vestibulum laoreet egestas ipsum tristique varius.Suspendisse iaculis. dignissim diam sit amet fringilla.</p>
            </div>
            <div class="tab3">
              <i class="fa fa-building-o i1" aria-hidden="true"></i>
              <h4 class="sub-w3l">Our Feature</h4>
              <p class="subp-w3l">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sollicitudin lobortis sem, sed fermentum neque condimentum ac. Phasellus elementum nibh Nunc in tempus neque, eu fermentum dolor. </p>
            ...
            <div class="panel-heading" role="tab" id="headingOne">
              <h4 class="panel-title asd">
                <a class="pa_italic" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                  <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>assumenda est cliche reprehenderit </a>
              </h4>
            </div>
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
              <div class="panel-body panel_text"> Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. </div>
            </div>
          </div>
          <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingTwo">
              <h4 class="panel-title asd">
                <a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                  <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>Itaque earum rerum </a>
              </h4>
            </div>
            ...
            <div class="panel-heading" role="tab" id="headingThree">
              <h4 class="panel-title asd">
                <a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                  <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>autem accusamus terry quibusdam </a>
              </h4>
            </div>
            ...
            <div class="panel-heading" role="tab" id="headingFour">
              <h4 class="panel-title asd">
                <a class="pa_italic collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                  <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="glyphicon glyphicon-minus" aria-hidden="true"></i>excepturi sint cliche reprehenderit </a>
              </h4>
            </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <img src="/images/modelimg.jpg" alt="image">
  ...
  <div class="footer-agile">
    <div class="container">
      ...
      <div class="col-md-7 footer-main2">
        <h4>Who we are</h4>
        <p>Lorem ipsum dolor sit amet Sed ut perspiciatis unde omnis iste natus error sit voluptatem dicta sunt explicabo.accusantium doloremque laudantium</p>
        <ul>
      ...
      <div class="copyright-agile">
        <p>© 2017 Real Property. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
      </div>
    </div>
  </div>
   <!--//footer-->
